...
if __name__ == "__main__":
    import sys
    run_host("out/soong/.intermediates/art/oatcheck/test_dex_loader/linux_glibc_x86_64/ca20aeb40531de8f5d4d80e90f476059/test_dex_loader", config["AOSP_ROOT"], "", *sys.argv[1:])